...
uint8_t const desc_configuration[] =
{
  ...
  TUD_HID_INOUT_DESCRIPTOR(ITF_NUM_HID, 4, HID_PROTOCOL_REPORT, sizeof(desc_hid_report), EPNUM_HID, 0x80 | EPNUM_HID, CFG_TUD_HID_EP_BUFSIZE, 1),

  TUD_VENDOR_DESCRIPTOR(ITF_NUM_WEBUSB, 5, EPNUM_WEBUSB, 0x80 | EPNUM_WEBUSB, CFG_TUD_VENDOR_EPSIZE)
};
